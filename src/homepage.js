        ...
        <div>
            <div className='' ref={headerRef} style={{paddingTop: '1px'}}>
                <div className='flex space-x-8 pr-8 mt-12 relative'>
                    ...
                    <p className='justify-center items-center flex text-center w-2/4 font-extrabold text-4xl'>Enhance your digital skills through social media and websites to increase productivity.</p>
                </div>
